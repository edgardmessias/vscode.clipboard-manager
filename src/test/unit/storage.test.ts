...
describe("storage helpers", () => {
  it("buildTitle normalizes whitespace and truncates to 120 chars", () => {
    const value = "  hello\n\nworld  ";
...
describe("legacy json migration", () => {
  ...
  it("migrates legacy json content into clip items", async () => {
...
describe("AppendLogStorage", () => {
  ...
  it("appends values and reloads clips by offset", async () => {
    const clips = [createClipItem("first clip"), createClipItem("second clip")];
  ...
  it("reuses offsets for duplicate checksums without growing values file", async () => {
  ...
  it("migrates legacy json file into v3 storage files", async () => {
  ...
  it("prunes dead values and preserves active checksum/title metadata", async () => {
  ...
  it("uses custom saveTo directory when configured", async () => {
...
describe("legacyClipToPartial", () => {
  it("preserves useCount from legacy clips", () => {
